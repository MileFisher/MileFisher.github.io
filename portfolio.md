...
Hi, I'm **Aung Khant Paing**, a **Software Engineering student at TDTU** with a strong interest in **full-stack development, AI-powered applications, and software deployment**. I enjoy turning ideas into working systems and learning by building projects that combine clean architecture, real-world problem solving, and modern development tools.
...
Guardrail LMS is a process-based academic integrity platform built around two core ideas: an integrity monitor and an AI-guided tutor. The system combines keystroke-dynamics telemetry, signed events, and anomaly detection with a separate Socratic learning assistant for non-assessed study sessions. The project also demonstrates full-stack deployment with a React frontend, an Express API backend, and a managed PostgreSQL database.

GitHub: https://github.com/MileFisher/Guardrail_LMS

#### AI Clinical Navigator
**Tech:** React, frontend development, AI integration planning
...
Advanced DB Final is a team-built fundraising platform composed of several services, including user and donation management, campaign and comment handling, a saga orchestrator, an API gateway, and a static frontend. This project shows my exposure to database-heavy system design, cross-service coordination, and combining SQL and NoSQL technologies in one application.

GitHub: https://github.com/SawBawMuThaw/advanced-db-final

#### Collaborative Projects
I have also contributed as a team member to several other academic projects:

- `MannDHHarry/Mobile_App_Wallet_Final` - an Android wallet application built with Java and Gradle
- `Saw-Baw-Mu-Thaw/soa-final` - a Learning Management System built with microservice architecture
- `Saw-Baw-Mu-Thaw/soa-midterm-main` - a Python-based service-oriented coursework project
- `MileFisher/ibanking-tuition-payment` and `MileFisher/soa-midterm` - fintech and service-oriented coursework projects
- `MileFisher/WebFinalProject` - a PHP note-taking web application

These team and coursework projects reflect my willingness to work across different stacks, contribute in collaborative environments, and strengthen my skills through hands-on implementation.
...
I am building my experience through academic and personal projects that connect software engineering theory with real implementation. My goal is to keep growing as a developer by working on systems that are useful, well-structured, and technically meaningful.
